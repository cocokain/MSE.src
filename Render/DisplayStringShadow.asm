0x521530 ; wstring displayString(std::wstring const&, int x, int y, int textcolor, int textalign, float scale):
...
MOV W3, WZR
MOV W4, W22
BL 0x694C0C ; Font::drawShadow(std::wstring const&, 0, 0, int textcolor)
